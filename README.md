...
- Tab **CAD**: import **DXF** georeferențiat **Stereo 70 (EPSG:3844)** → conversie client în WGS84, entități **LINE / LWPOLYLINE / POLYLINE / CIRCLE / ARC / TEXT / MTEXT / INSERT**, grupate pe **numele layer-ului CAD**.
...
2. Convertește **DWG → DXF** (preferă **ASCII DXF**, spațiu **MODEL**, păstrează **TEXT/MTEXT** la export).
...
**Limită:** blocuri `INSERT` complexe cu atribute pot fi importate doar ca puncte de inserare (MVP).
